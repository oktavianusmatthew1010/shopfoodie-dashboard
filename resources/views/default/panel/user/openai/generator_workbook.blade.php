                        ...
                        @foreach (json_decode($openai->questions) ?? [] as $question)
                            ...
                            >
                                ...
                                @if ($question->type === 'rss_feed')
                                    <x-slot:action>
                                        <button
                                                class="fetch-rss flex h-full items-center gap-2 rounded-e-inpu1t px-3 text-2xs font-medium transition-colors hover:bg-secondary hover:text-secondary-foreground"
                                                type="button"
                                        >
