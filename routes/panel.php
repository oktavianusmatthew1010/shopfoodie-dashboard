    ...
    Route::prefix('dashboard')
        ...
        ->group(static function () {
            ...
            Route::prefix('setup')->name('setup.')->group(function () {
                Route::get('/my-requests', [SetupController::class, 'list'])->name('list');
                Route::get('/new-setup-request', [SetupController::class, 'newSetup'])->name('new');
                Route::post('/new-setup-request/send', [SetupController::class, 'newTicketSend']);

                Route::get('/requests/{ticket_id}', [SetupController::class, 'viewTicket'])->name('view');
                Route::post('/requests-action/send-message', [SetupController::class, 'viewTicketSendMessage']);
            });
